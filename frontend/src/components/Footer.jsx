...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="border-t border-orange-100 bg-[#fffaf5] px-4 pb-8 pt-7 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-8 rounded-3xl border border-slate-200 bg-[#fffaf5] p-6 shadow-sm md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="font-['Outfit'] text-base font-bold text-slate-900">Quick Links</h3>
          ...
          <div>
            <h3 className="font-['Outfit'] text-base font-bold text-slate-900">Platform</h3>
            <div className="mt-4 space-y-2">
          ...
          <div>
            <h3 className="font-['Outfit'] text-base font-bold text-slate-900">Contact</h3>
